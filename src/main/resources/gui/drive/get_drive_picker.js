...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.PfVn9bJ7bGE.O/m\u003d__features__/am\u003dQQE/rt\u003dj/d\u003d1/rs\u003dAGLTcCNlWgxEckRCs4JLfDIXoy5jFXYrVQ",
...
(function() {
    ...
    function createPicker() {
        javaBridge.log("JS Token " + accessToken);
        ...
        if (accessToken) {
            ...
            javaBridge.setPickerSource(pickerUri);
            javaBridge.setPickerSource("6");
