...
public class RefutationSpeech extends Speech {
    private static final RefutationSpeech AT_AFF_1 = new RefutationSpeech(DefensiveSpeech.AFF_1, Side.NEGATION,"AT Aff 1");
    private static final RefutationSpeech AT_AFF_2 = new RefutationSpeech(DefensiveSpeech.AFF_2, Side.NEGATION, "AT Aff 2");
    private static final RefutationSpeech AT_AFF_3 = new RefutationSpeech(DefensiveSpeech.AFF_3, Side.NEGATION, "AT Aff 3");
    private static final RefutationSpeech AT_AFF_4 = new RefutationSpeech(DefensiveSpeech.AFF_4, Side.NEGATION, "AT Aff 4");
    private static final RefutationSpeech AT_NEG_1 = new RefutationSpeech(DefensiveSpeech.NEG_1, Side.AFFIRMATIVE, "AT Neg 1");
    private static final RefutationSpeech AT_NEG_2 = new RefutationSpeech(DefensiveSpeech.NEG_2, Side.AFFIRMATIVE, "AT Neg 2");
